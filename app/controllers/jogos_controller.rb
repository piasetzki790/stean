class JogosController < ApplicationController
  ...
  # GET /jogos.json
  def index
    @jogos = Jogo.por_titolo (params[:titolo])
    end
  ...
  def create
    ...
    respond_to do |format|
      if @jogo.save
        format.html { redirect_to actions: :index, notice: 'Jogo was successfully created.' }
  ...
  private
    ...
    def jogo_params
      params.require(:jogo).permit(:titolo, :descrcao, :desenvolvedora, :lancamento, :classificacao_id)
    end
